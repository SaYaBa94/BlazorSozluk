...
namespace BlazorSozluk.Common.Infrastructure
{
    public static class QueueFactory
    {
        ...
        public static EventingBasicConsumer CreateBasicConsumer()
        {
            ...
            {
                HostName = BlazorSozlukConstants.RabbitMQHost,
            };
        ...
        public static EventingBasicConsumer EnsureExchange(this EventingBasicConsumer consumer, string exchangeName, string exchangeType = BlazorSozlukConstants.DefaultExchangeType)
        {
