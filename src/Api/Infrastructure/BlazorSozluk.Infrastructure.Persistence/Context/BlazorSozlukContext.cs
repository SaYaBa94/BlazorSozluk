...
namespace BlazorSozluk.Infrastructure.Persistence.Context
{
    public class BlazorSozlukContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                var connStr = "Server=.\\SQLExpress;Database=BlazorSozluk;User Id=yasin;Password=sadri45";
        ...
        {
            var addedEntities = ChangeTracker.Entries().Where(e => e.State == EntityState.Added).Select(e => (BaseEntity)e.Entity);
